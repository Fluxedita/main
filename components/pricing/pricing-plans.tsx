...
export const plans = [
  ...
  },
  {
    ...
    valueProposition: {
      title: "Exceptional Value: Unlimited Reusability",
      tagline: "🌱 Root Package — A complete multi-page website framework with 40+ admin and utility pages — the perfect foundation for serious projects with growth in mind.",
  ...
  },
  {
    ...
    valueProposition: {
      title: "Exceptional Value: Unlimited Reusability",
      tagline: "🧩 Multi Package — Everything in Root, plus advanced structure and content scaling for multi-page sites with navigation, collections, and growth-ready architecture.",
      text: "This package offers **unlimited reusability by the purchaser** across any number of your own projects, **plus 12 months of safe app‑code updates** that never overwrite your content or database. Build once, deploy many times, saving countless hours and costs. This license is non-transferable.",
    },
  ...
  },
  {
    ...
    valueProposition: {
      title: "Exceptional Value: Unlimited Reusability",
      tagline: "💎 Premium Package — All the power of Multi plus advanced interactivity — live messaging, comments, likes, favourites, premium content, and dynamic media sets, fully guided from day one.",
      text: "This package offers **unlimited reusability by the purchaser** across any number of your own projects, **plus 12 months of safe app‑code updates** that never overwrite your content or database. Build once, deploy many times, saving countless hours and costs. This license is non-transferable.",
    },
  ...
  },
  {
    ...
    perfectFor: [
      "Agencies delivering multiple client sites",
      "Teams needing higher limits and governance",
      "White-label client projects",
      "Multi-brand or multi-region rollouts",
      "SLA-backed support requirements",
      "SSO and enterprise controls",
      "Faster support response targets",
    ],
    valueProposition: {
      title: "Exceptional Value: Unlimited Reusability",
      tagline: "🏢 Agency Package — Everything in Premium, with multi-site management, higher resource limits, priority support, and white-label options built for professional teams and client delivery.",
      text: "This package offers **unlimited reusability by the purchaser** across any number of your own projects, **plus 12 months of safe app‑code updates** that never overwrite your content or database. Build once, deploy many times, saving countless hours and costs. This license is non-transferable.",
    },
    features: [
      "Fully editable Home page, /Products/Main page, /about page, contact page with live preview",
  ...
  },
  {
    ...
    perfectFor: [
      "Creators building multiple products over time",
      "Agencies wanting no ongoing license fees",
      "Long-term projects with continuous updates",
      "Early adopters who want maximum value",
      "Teams standardizing on Fluxedita",
      "Solo founders wanting a predictable cost",
    ],
    valueProposition: {
      title: "Exceptional Value: Unlimited Reusability",
      tagline: "♾️ Lifetime Package — One payment for full, forever access to Premium — a limited early-adopter offer for creators and agencies who want scalability without ongoing fees.",
      text: "This package offers **unlimited reusability by the purchaser** across any number of your own projects, **plus 12 months of safe app‑code updates** that never overwrite your content or database. Build once, deploy many times, saving countless hours and costs. This license is non-transferable.",
    },
    features: [
      "Fully editable Home page, /Products/Main page, /about page, contact page with live preview",
